...
/* Link selling price to consumer
  * One to many relation */
SellingPrice.hasMany(Consumer, { foreignKey: { name: "selling_price_id", allowNull: false } })
Consumer.belongsTo(SellingPrice, { foreignKey: { name: "selling_price_id", allowNull: false } })
...
/* Link SpotPrice to EnergyGeneration
  * One to many relation */
SpotPrice.hasMany(EnergyGeneration, { foreignKey: { name: "spot_price_id", allowNull: false } })
EnergyGeneration.belongsTo(SpotPrice, { foreignKey: { name: "spot_price_id", allowNull: false } })
